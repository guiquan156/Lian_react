...
/***/ function(module, exports, __webpack_require__) {
	...
	function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } } //less
	...
	ReactDOM.render(React.createElement(
		...
		React.createElement(
			...
			React.createElement(
				...
				React.createElement(_reactRouter.Route, { path: '/test', component: _test2.default })
			)
		)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoList = __webpack_require__(130);
