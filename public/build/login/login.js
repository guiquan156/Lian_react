	...
	var Login = function (_React$Component) {
		...
		_createClass(Login, [{
			...
			value: function loginHandler() {
				...
				if (data.userId == '') alert('用户名不能为空');else if (data.psw == '') alert('用户密码不能为空');else fetch('?action=login', {
					method: 'post',
					headers: {
			...
			value: function render() {
				return React.createElement(
					...
					React.createElement('input', { type: 'text', className: 'form-control user-id', ref: 'userId' }),
					React.createElement(
						'h4',
						null,
						'password: '
					),
					React.createElement('input', { type: 'password', className: 'form-control', ref: 'pwd' }),
					React.createElement(
						'div',
						{ className: 'text-center button_row' },
						React.createElement(
							'button',
							{ className: 'btn btn-success', onClick: this.loginHandler },
							'login'
						),
						React.createElement(
							'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body{background-color:#eee;overflow:hidden}#login{width:300px;margin:90px auto 0;padding:40px 20px;background-color:#fff;border:1px solid #ddd;border-radius:5px;box-shadow:0 0 10px #ccc}#login .button_row{margin-top:20px}#login .button_row button{margin:0 10px}.test{display:-webkit-box;display:-ms-flexbox;display:flex}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(151)(IteratorPrototype, __webpack_require__(146)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(186)($Promise, PROMISE);
